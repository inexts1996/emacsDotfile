...
;; accept. For example:
;;
(setq doom-font (font-spec :family "Maple Mono NF CN" :size 15 :weight 'normal)
...
(require 'mode-line-bell nil t)  ;; <- 确保包已安装
(mode-line-bell-mode t)


;; todoist config
(setq todoist-token "4e3dcefed37d75dc2451768d3da7a7c883db18e4")
;;(org-todoist-sync &optional ARG)
(setq org-todoist-api-token "4e3dcefed37d75dc2451768d3da7a7c883db18e4")

(after! lsp-bridge
  ;; Use the server installed with: dotnet tool install -g csharp-ls
